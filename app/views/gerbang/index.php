...
<body>
    ...
    <div class="login-container text-center">
        ...
        <div class="login-box mx-auto">
            <form method="post" action="<?= BASEURL; ?>/controllers/users.php">
                <div class="form-group text-left">
                    <label for="username">Username</label>
                    <input type="text" class="form-control" name="name/email" placeholder="Value">
                </div>
                <div class="form-group text-left">
                    <label for="password">Password</label>
                    <input type="password" class="form-control" name="usersPwd" placeholder="Value">
                </div>
