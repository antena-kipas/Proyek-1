...
<body>
    <nav class="navbarr">
        ...
        <div class="mt-3">
            ...
            <ul class="nav-linkss">
                <li><a href="http://proyek-1.test/">Beranda</a></li>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <section class="content">
                    <p>Sesuai dengan Permenkes No 43 Tahun 2019, puskesmas memiliki peran sebagai gerbang pertama yang
                        diharapkan bisa memberikan pelayanan kesehatan kepada masyarakat secara komprehensif, tidak
                        ...
                        terlibat dalam peningkatan kesehatan masyarakat.</p>

                    <div class="ukm-essensial mt-3">
                        UKM ESSENSIAL
                    </div>
                    <p class="mt-3">Upaya Kesehatan Masyarakat (UKM) Esensial merupakan upaya kesehatan yang wajib atau
                        harus dilaksanakan oleh suatu puskesmas demi mencapai Standar Pelayanan Minimal Kabupaten/Kota
                        bidang kesehatan.</p>
                    <ul>
                        <li>Pelayanan promosi kesehatan</li>
                        <li>Pelayanan kesehatan lingkungan</li>
                        <li>Pelayanan kesehatan ibu, anak, dan keluarga berencana</li>
                        <li>Pelayanan gizi</li>
                        <li>Pelayanan pencegahan dan pengendalian penyakit</li>
                    </ul>
                </section>
            </div>
        </div>
