                            ...
                            <div class="card-body table-responsive p-0">
                                <?php if (!empty($model['rekapList'])): ?>
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            <?php foreach ($model['rekapList'] as $rekap): ?>
                                                <tr>
                                                    <td><?= htmlspecialchars($rekap->no) ?></td>
                                                    <td><?= htmlspecialchars($rekap->nama_laporan) ?></td>
                                                    <td><?= htmlspecialchars($rekap->tanggal_waktu) ?></td>
                                                    <td><a href="/download-grouped-data" class="btn btn-primary">Download Data Laporan</a></td>                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
