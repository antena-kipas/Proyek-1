...
<body>
    ...
    <div class="container">
        <div class="form-section">
            <div class="text-left">
                <div class="form-title">KONTAK KAMI</div>
            </div>
            <div class="form-description mt-3 font-weight-bold" style="font-size: 18px">
                Layanan pesan atau kesan anda terhadap layanan kami, bisa anda tinggalkan pada form dibawah ini,
                Terimakasih
            </div>
