...
<head>
  ...
  <link rel="stylesheet" href="http://proyek-1.test/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="http://proyek-1.test/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #009427">
    ...
    <a href="#" class="brand-link">
      <img src="http://proyek-1.test/dist/img/Logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="http://proyek-1.test/dist/img/User_logo.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/Akumulasi" class="nav-link">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="col mb-2">
          ...
          <br>
          <br>
          <div class="card card-outline card-success col-sm-6">
              <div class="card-header">
                <h3 class="card-title">Program UKM Kesehatan Lingkungan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <ul class="nav flex-column nav-pills nav-sidebar">
                    <li class ="nav-item"><p><i class="nav-icon fas fa-house-user"></i>Perilaku penghuni</p></li>
                    <li class ="nav-item"><p><i class="nav-icon fas fa-hand-holding-water"></i>Pemeriksaan Kualitas air secaara fisik</p></li>
                    <li class ="nav-item"><p><i class="nav-icon fas fa-toilet"></i>Sanitasi Sarana jamban keluarga</i></p></li>
                    <li class ="nav-item"><p><i class="nav-icon fas fa-water"></i>Sanitasi Sarana air bersih</p></li>
                    <li class ="nav-item"><p><i class="nav-icon fas fa-hospital-user"></i>Rumah sehat</p></li>
                  </ul>
              </div>
            </div>
        </div><!-- /.row -->
